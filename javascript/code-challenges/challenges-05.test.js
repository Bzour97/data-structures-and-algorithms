...
const addValues = (arr) => {
  // Solution code here...
  let answer = arr.reduce((acc,values) => {
    return acc + values;
  }, 0);
  return answer;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((acc,values) => acc + values.purchasePrice, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  let ans = arr.reduce((account, current) => {
    account.push(current.name);
    return account;
  }, []);
  return ans;
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce( (stringA,stringB) => stringB + stringA, '');
};
